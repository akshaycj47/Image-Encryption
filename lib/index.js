...
module.exports = {
     ...
     * If present, result will id, encrypted buffer, and encrypted data key
     */
     ...
     * @param {function} callback - Two param err, result callback
     * If present, result will be encrypted buffer and encrypted data key
     */
        ...
        Async.series([
            ...
            (next) => {
                ...
                Store.load(params.inputPath, (err, res) => {
                    ...
                    encObj = res;
                    retVal.encDataKey = encObj.encDataKey;
                    retVal.encBuff = encObj.encBuff;
                    next();
                });
            },
            (next) => {
